...
func (c *authServiceClient) ValidateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenResponse, error) {
...
func (UnimplementedAuthServiceServer) ValidateToken(context.Context, *Token) (*TokenResponse, error) {
